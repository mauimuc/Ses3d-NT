...
Known bugs:
    * true, false, .true., .false., t, f and mixed- and upper case variants
        must not be used as keys
    * Slice assignments are not supported
...
def auto_token(value):
    ...
    elif value.lower() in [".true.", "true", "t"]:
...
class NameListTestCase(unittest.TestCase):
    ...
    def test_boolean_values(self):
        """
        Tests if True, False, .True., .False., T, and F all are valid boolean
        values.
        """
        group = (
            "&group\n"
